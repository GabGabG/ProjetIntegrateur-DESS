...
if __name__ == '__main__':
    ...
    train_and_valid_Adam(device, "metadata.csv", data_root_500, model_saves, lr, batch_size, np.inf, n_epochs, 0.8,
                         callback_base_name, "predictions/predictions_v1.npz.", cnn_out_channels=(16, 32, 64))
    ...
    train_and_valid_Adam(device, "metadata.csv", data_root_500, model_saves, lr, batch_size, np.inf, n_epochs, 0.8,
                         callback_base_name, "predictions/predictions_v2.npz.", cnn_out_channels=(8, 8), cnn_mlp_out=32,
                         gru_hidden_size=64)
    ...
    train_and_valid_Adam(device, "metadata.csv", data_root_5000, model_saves, lr, batch_size, np.inf, n_epochs, 0.8,
                         callback_base_name, "predictions/predictions_v3.npz.", cnn_out_channels=(8, 16))
    ...
    train_and_valid_Adam(device, "metadata.csv", data_root_5000, model_saves, lr, batch_size, np.inf, n_epochs, 0.8,
                         callback_base_name, "predictions/predictions_v4.npz.", cnn_out_channels=(8, 16))
    ...
    train_and_valid_Adam(device, "metadata.csv", data_root_5000, model_saves, lr, batch_size, np.inf, n_epochs, 0.8,
                         callback_base_name, "predictions/predictions_v5.npz.", cnn_out_channels=(8, 16))
