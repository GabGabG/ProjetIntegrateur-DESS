...
\\ \\
Si le temps le permet, il serait aussi intéressant de tester différentes variantes, notamment l'ajout de bruit, la non uniformité de la tache laser et la variation spatiale du temps caractéristique de corrélation. Les deux premiers cas sont relativement triviaux, alors que le dernier requiert une refonte de l'algorithme à l'étape de création des amplitudes complexes et lors de la pondération par les valeurs propres. Pour l'instant, seules les tache uniforme sans bruit et de temps de corrélation stationnaire dans l'espace sont considérés. La figure \ref{} montre trois simulations d'une même séquence où le temps d'intégration est de $0.3$ seconde et le temps caractéristique est de $1$ seconde. La corrélation de la séquence au complet est présentée à la figure \ref{}. À la figure \ref{}, on montre trois simulations aussi d'une même séquence, mais cette fois le temps d'intégration est de $1$ seconde pour un temps caractéristique de $0.3$ seconde. La corrélation de la séquence au complet est présentée à la figure \ref{}. À noter la différence de la courbe. Dans le premier cas, la corrélation est exponentielle, alors que dans le second cas elle est gaussienne. Ce genre d'images seront générées pour différents paramètres et serviront à l'entraînement, la validation et le test.
